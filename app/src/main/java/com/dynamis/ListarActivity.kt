...
class ListarActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnListarNoSocios.setOnClickListener{
            val intent = Intent(this, ListarNoSociosActivity::class.java)
            startActivity(intent)}
    ...
    private fun mostrarDialogoDeAyuda() {
        ...
        builder.setTitle("Ayuda: Listar")
        builder.setMessage(
            "Aquí podrás ver las listas de socios, no socios y vencimientos."
        )
